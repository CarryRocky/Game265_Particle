...
AParticle::AParticle(float pV, Vector2f angleVec)
{
	velocity = pV;
...
void AParticle::updateParticle(float dt)
{
	if (velocityStrategy != NULL)
	{
...
float AParticle::randomFloat(float a, float b)
{
...
StrategyBase* AParticle::chooseStrategy(int pType,float a,float b)
{
	if (pType == LINEAR_S)
	{
...
void AParticle::setSizeStrategy(int pType, float a, float b)
{
	sizeStrategy = chooseStrategy(pType,a,b);
}

void AParticle::setVelocityStrategy(int pType, float a, float b)
{
	velocityStrategy = chooseStrategy(pType, a, b);
}

void AParticle::setRotationStrategy(int pType, float a, float b)
{
